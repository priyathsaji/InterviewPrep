...
Johnson's Algorithm is a combination of the Bellman-Ford and Dijkstra's algorithms that
finds the shortest paths between all pairs of vertices in a weighted graph. It can handle
negative edge weights and is more efficient than Floyd-Warshall for sparse graphs.

Time Complexity:
- Best: O(VE log V) where V is the number of vertices and E is the number of edges
- Average: O(VE log V)
- Worst: O(VE log V)
...
Characteristics:
1. Combines Bellman-Ford and Dijkstra's algorithms
2. Can handle negative edge weights
3. More efficient than Floyd-Warshall for sparse graphs
...
def johnson_shortest_paths(vertices: int, edges: List[Tuple[int, int, float]]) -> Tuple[List[List[float]], List[List[int]], bool]:
    """
    Find the shortest paths between all pairs of vertices using Johnson's algorithm.
    ...
    Example:
        ...
        >>> distances, next_vertices, has_cycle = johnson_shortest_paths(vertices, edges)
        >>> distances[0][3] == 5
        True
    """
    raise NotImplementedError("Johnson's algorithm implementation not completed")

def johnson_shortest_paths_with_constraints(vertices: int, edges: List[Tuple[int, int, float]],
                                          required_edges: List[Tuple[int, int]]) -> Tuple[List[List[float]], List[List[int]], bool]:
    """
    Find the shortest paths between all pairs of vertices with required edges using Johnson's algorithm.
    ...
    Example:
        ...
        >>> edges = [(0, 1, 10), (0, 2, 6), (0, 3, 5), (1, 3, 15), (2, 3, 4)]
        >>> required = [(0, 1)]
        >>> distances, next_vertices, has_cycle = johnson_shortest_paths_with_constraints(vertices, edges, required)
        >>> distances[0][1] == 10
        True
    """
    raise NotImplementedError("Johnson's algorithm with constraints implementation not completed")

def johnson_shortest_paths_with_capacity(vertices: int, edges: List[Tuple[int, int, float, float]],
                                       capacity_constraints: Dict[int, float]) -> Tuple[List[List[float]], List[List[int]], bool]:
    """
    Find the shortest paths between all pairs of vertices with vertex capacity constraints using Johnson's algorithm.
    ...
    Example:
        ...
        >>> distances, next_vertices, has_cycle = johnson_shortest_paths_with_capacity(vertices, edges, constraints)
        >>> distances[0][3] == 5
        True
    """
    raise NotImplementedError("Johnson's algorithm with capacity constraints implementation not completed")

def find_negative_cycles(vertices: int, edges: List[Tuple[int, int, float]]) -> List[List[int]]:
    """
    Find all negative cycles in the graph using Johnson's algorithm.
...
class TestJohnson(unittest.TestCase):
    def test_johnson_shortest_paths(self):
    ...
    def test_johnson_shortest_paths_with_constraints(self):
        ...
        with self.assertRaises(ValueError):
            johnson_shortest_paths_with_constraints(vertices, edges, required)
    ...
    def test_johnson_shortest_paths_with_capacity(self):
        ...
        with self.assertRaises(ValueError):
            johnson_shortest_paths_with_capacity(vertices, edges, constraints)
    ...
    def test_edge_cases(self):
        ...
        with self.assertRaises(ValueError):
            johnson_shortest_paths(vertices, edges)
